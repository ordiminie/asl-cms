-- Isolation multi-tenant de `news` (ADR 002, ADR 023).
-- Fichier prepare par `drizzle-kit generate --custom`, patron de
-- `0015_menu_item_rls.sql` : RLS activee ET forcee, policy
...
-- `page` et de `menu_item` : une actualite porte sa propre colonne de tenant.
--
...
ALTER TABLE "news" FORCE ROW LEVEL SECURITY;--> statement-breakpoint
