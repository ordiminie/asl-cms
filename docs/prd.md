...
| Navigation du site public (menu, en-tête, pied de page éditables)                             | 2                | Une page publiée mais absente du menu n'est atteignable qu'en tapant son URL : le critère de succès « le bureau crée, modifie et publie une page sans intervention du prestataire » ne serait pas tenu. s34 s'appuie déjà dessus (« aucune navigation n'y renvoie » quand le module est désactivé). Ordre des entrées, page cible, visibilité — pas de menus à plusieurs niveaux. |
| Identité visuelle par association (logo, teinte d'accent, favicon)                            | 2                | Sans elle, six associations servent le même logo et la même couleur : la promesse « son site à elle » tombe à la première visite. Le design system la réduit à deux variables — un logo et une teinte choisie dans six valeurs validées — et le gabarit d'email de s25 exige déjà « un en-tête au logo de l'association ».                                                        |
