...
_Non retenu comme argument, bien que vrai : le fait que Lotisoft gère lui-même la finance là où ASL-CMS la délègue à Pennylane. C'est une contrainte de conception, pas un avantage vendable._
...
| Connexion par lien magique (validité 20 min)                                                  | 3                | Natif Better Auth, mais flux d'invitation, expiration et absence de mot de passe à éprouver auprès d'un public âgé. Le flux d'invitation inclut le suivi d'adoption au lancement — qui a été invité, qui s'est connecté — sans quoi le premier contact avec 400 propriétaires se ferait à l'aveugle.                                                                                                                                                                                                           |
| Pages publiques + formulaire de contact archivé en BO                                         | 2                | Formulaire, persistance, liste consultable, notification paramétrable.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Navigation du site public (menu et pied de page éditables)                                    | 2                | Une page publiée mais absente du menu n'est atteignable qu'en tapant son URL : le critère de succès « le bureau crée, modifie et publie une page sans intervention du prestataire » ne serait pas tenu. Un module désactivé doit par ailleurs ne laisser aucune entrée de menu morte. Ordre des entrées, page cible, visibilité — pas de menus à plusieurs niveaux. L'en-tête n'est pas éditable librement : ce qu'il porte d'association est le logo et la teinte, servis par la ligne « Identité visuelle ». |
| Identité visuelle par association (logo, teinte d'accent, favicon)                            | 2                | Sans elle, six associations servent le même logo et la même couleur : la promesse « son site à elle » tombe à la première visite. Le design system ramène la teinte à une seule variable, choisie dans six valeurs validées ; le logo et le favicon sont deux fichiers fournis par l'association. Les gabarits d'email en dépendent autant que le site : leur en-tête porte le logo de l'association.                                                                                                          |
...
| Désinscription et classification des communications                                           | 2                | Le lien de désinscription est une obligation légale sur tout envoi de masse. Chaque modèle porte une nature : un désinscrit sort des envois facultatifs, reste dans les envois statutaires (convocation, facture, relance) auxquels son appartenance à l'association l'engage. Classification en configuration, à confirmer avec le conseil RGPD.                                                                                                                                                              |
| Bandeau d'alerte global                                                                       | 1                | Activation / édition / désactivation par tout membre du bureau. **Un seul niveau de gravité, non refermable par le visiteur** — arbitrage rendu le 23/09/2026 : le CDC n'en demande pas et le bureau n'en veut pas. Les trois niveaux décrits par le design system §2.3 restent une extension documentée, hors périmètre V1 ; les rouvrir serait un élargissement de périmètre, qui repasserait par ce document.                                                                                               |
...
| Notes internes et historique par membre _(inspiré de Lotisoft)_                               | 2                | Fiche membre côté bureau : notes privées et historique des échanges. Assure la continuité quand le bureau change. **Sensible RGPD** : ce sont des notes sur des personnes.                                                                                                                                                                                                                                                                                                                                     |
...
| Signalements avec catégories et statuts _(généralisé, inspiré de Lotisoft)_                   | 3                | Workflow `signalé → en cours → résolu`, en version publique anonyme et en version membre identifiée. Généralisé au-delà des fuites d'eau : voirie, éclairage, nuisance. La V5 §5.6 parle déjà de « fuite ou d'incident ».                                                                                                                                                                                                                                                                                      |
...
| Publipostage PDF pour les membres sans email _(inspiré de Lotisoft)_                          | 3                | Une campagne génère un PDF à variables dynamiques, prêt à imprimer et poster. **Fait entrer dans le produit le quart de membres aujourd'hui hors système.**                                                                                                                                                                                                                                                                                                                                                    |
| Groupes de destinataires personnalisés _(inspiré de Lotisoft)_                                | 2                | Au-delà des deux cibles actuelles (tous / impayés) : groupes composés par le bureau.                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Statistiques d'ouverture et de clic des campagnes _(inspiré de Lotisoft)_                     | 2                | Brevo les mesure déjà ; il s'agit de les restituer en back-office.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Modèles de documents réutilisables _(inspiré de Lotisoft)_                                    | 3                | Convocation, PV, courrier type — au-delà des modèles d'email. Génération unitaire et **en lot** pour un groupe, avec dépôt dans les dossiers nominatifs : une convocation d'AG se produit pour tous les membres à la fois, la produire une par une serait inutilisable pour un bureau bénévole.                                                                                                                                                                                                                |
...
| Export et portabilité des données _(inspiré de Lotisoft)_                                     | 3                | Export complet dans un format ouvert. Répond au droit à la portabilité RGPD et constitue un argument anti-verrouillage face aux concurrents.                                                                                                                                                                                                                                                                                                                                                                   |

**Modules activables par tenant**

| Feature                                         | Complexity (1-5) | Why this score                                                                                                                                                                                                                                                            |
| ----------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Vote : interface + implémentation ASL Community | 3                | Redirection, publication des résolutions, des résultats et du PV. Aucune logique de vote développée. Traité derrière une interface interchangeable — voir _L'angle_. Saisie des résolutions et publication réservées à la présidente.                                     |
