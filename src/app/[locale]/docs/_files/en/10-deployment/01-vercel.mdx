...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'your-project.supabase.co', // Your Supabase domain
      },
    ],
  },

  // Cache Components: 'use cache' directive, cacheLife/cacheTag, and Partial
  // Prerendering by default. Replaces the removed experimental.useCache flag.
