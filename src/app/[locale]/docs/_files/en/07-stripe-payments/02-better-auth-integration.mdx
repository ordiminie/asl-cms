...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Automatic customer creation, webhook processing, and database synchronization</p>
  </div>
  ...
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Webhooks automatically update subscription status and user access</p>
  </div>
  ...
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Automatic email notifications for all subscription lifecycle events</p>
  </div>
  ...
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Webhook verification, authorization checks, and secure data handling</p>
  </div>
</div>
